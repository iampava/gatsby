  ...
  cli.command({
    ...
    builder: _ =>
      _.option(`H`, {
        ...
        .option(`deletion-config-file`, {
          type: `string`,
          describe: `JSON file containing a 'string[]' with HTML pages to delete in this build. This allows user-controlled incremental builds.`,
        }),
    handler: handlerP(
      getCommandHandler(
        `develop`,
